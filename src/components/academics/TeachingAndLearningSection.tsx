...
export default function TeachingAndLearningSection() {
  ...
  return (
    <section className="bg-[#fcfdfe] pb-12" id="approach">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-0">
        <div className="bg-[#0a192f] rounded-[40px] p-10 md:p-14 flex flex-col lg:flex-row gap-4 items-center relative overflow-hidden shadow-xl">
          ...
          {/* Right Carousel Area */}
          <div className="lg:w-[71%] w-full relative z-10 mt-10 lg:mt-0">
            {/* Navigation Arrows */}
