...
export default function AcademicsHeroSection() {
  return (
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left max-w-2xl">
            <span className="text-[#dfae19] font-bold text-[12px] tracking-[0.2em] uppercase mb-4 block">Academics</span>
            
            <h1 className="font-serif text-3xl sm:text-4xl md:text-[55px] font-medium leading-[1.3] mb-6 text-[#0a192f]">
              Learning Today, <br />
              Leading <span className="font-script text-lf-burgundy text-[40px] sm:text-[48px] md:text-[60px] relative inline-block -my-2 pr-2">
                 Tomorrow.
            ...
            <p className="text-[15px] text-gray-600 mb-8 leading-relaxed">
              At Little Flower, academics go beyond textbooks. We nurture curiosity, build strong foundations, and inspire a love for lifelong learning to equip students for an ever-changing world.
            </p>

            <a href="#approach" className="inline-flex items-center gap-2 bg-lf-burgundy text-white px-5 lg:px-8 py-2.5 lg:py-3.5 rounded-[16px] font-semibold hover:bg-lf-burgundy-hover transition-colors text-sm">
